...
public class GroupingTransform extends DocumentTransform.DefaultDocumentTransform {
    ...
    /**
     * web server calls this CTOR with flatten = true
     * 
     * @param logic
    ...
    /**
     * tserver calls this CTOR (flatten defaults to false)
     * 
     * @param logic
     * @param groupFieldsSet
     */
    ...
    /**
     * flatten documents to just one document with the fields and counts correlated with a grouping context suffix
     * 
     * @param documents
     */
